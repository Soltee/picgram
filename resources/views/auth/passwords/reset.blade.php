...
<div class="max-w-sm mx-auto">
    ...
    <form method="POST" class="mt-10" action="{{ route('password.update') }}">
        @csrf
        ...
        <div class="max-w-sm mb-4">
            ...
            <div class="max-w-lg mt-4 mb-4">
                <button class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-6 mr-2 rounded">
                      {{ __('Reset Password') }}
