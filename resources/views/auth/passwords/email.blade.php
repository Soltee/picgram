...
<div class="min-h-screen overflow-hidden  bg-c-white z-20 px-6  md:px-0 flex flex-col justify-center md:items-center mx-auto ">
              ...
              @csrf
                <div class="w-full flex flex-col justify-center">
                    ...
                    <div class="mb-4  w-full">
                        ...
                        <input class="@error('email') is-invalid @enderror shadow appearance-none border rounded w-full py-2 px-3 text-blue-light leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="*******@gmail.com">
                        @error('email')
                    ...
                    <div class="flex flex-col justify-center mt-4 w-full">
                        <button  type="submit" id="logBtn" class="w-full font-bold text-lg bg-blue-light hover:opacity-80 text-c-white py-2 px-6 rounded">
                            Send Request
                        </button>
