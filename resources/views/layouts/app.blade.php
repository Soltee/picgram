...
<body class="">
    <div id="app">
        ...
        @auth
            ...
            <nav class="bg-c-blue   px-6 py-4 md:px-16 md:py-6 border-white border-b-2">
                <div class="flex justify-between items-center lg:max-w-4xl lg:mx-auto">
                    <div class="flex items-center">
                        <a class="flex flex-row items-center mr-6" href="{{ url('/') }}">
                            <svg class="h-8 w-8  md:w-10 md:h-10 text-c-white pr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
                            <span class="pl-2 border-c-blue border-l-2 font-serif text-md md:text-lg text-c-white font-bold">Picgram</span>
                        </a>
                        <search-model></search-model>
                    </div>
                    <div class="flex items-center">
                        <ul class="hidden md:inline-flex justify-end items-center">
                            <li class="mr-4  hover:opacity-75 {{ Route::currentRouteName() == 'home' ? 'opacity-75' : 'text-c-white' }}">
                                <a class="" href="{{ route('home') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8 text-c-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                </a>
                            </li>
                            <li class="mr-4  hover:opacity-75 {{ Route::currentRouteName() == 'posts.create' ? 'opacity-75' : 'text-c-white' }}">
                            ...
                            <li class="mr-4  hover:opacity-75 {{ Route::currentRouteName() == 'browse' ? 'opacity-75' : 'text-c-white' }}">
