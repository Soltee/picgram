...
<body class="">
    <div id="app">
        ...
        @auth
            ...
            <nav class="bg-c-blue-800   px-6 py-4 md:px-16  border-white border-b-2">
                <div class="flex justify-between items-center lg:max-w-4xl lg:mx-auto">
                    <div class="flex items-center">
                        <a class="flex flex-row items-center mr-6" href="{{ url('/') }}">
                            ...
                            <span class="pl-2 border-c-blue-800 border-l-2 font-serif text-md md:text-lg text-c-white font-bold">Picgram</span>
                        </a>
