            ...
            <div class="flex justify-between items-center lg:max-w-4xl lg:mx-auto">
                ...
                <div class="flex items-center">
                    <ul class="hidden md:inline-flex justify-end items-center">
                        <li class="mr-4 {{ Route::currentRouteName() == 'home' ? '' : 'text-c-white' }}">
                        ...
                        <li class="mr-4 {{ Route::currentRouteName() == 'posts.create' ? '' : 'text-c-white' }}">
                        ...
                        <li class="mr-4 {{ Route::currentRouteName() == 'browse' ? '' : 'text-c-white' }}">
