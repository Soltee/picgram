    ...
    <div class="relative flex flex-row items-center relative">
        <div class="flex items-center">
            <a class="mr-2" :href="`/profile/${auth.id}/${auth.name}`">
                <img v-if="profile.avatar" class="w-8 h-8    bg-cover rounded-full" :src="`/storage/${profile.avatar }`">
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-8 h-8    bg-cover rounded-full" viewBox="0 0 20 20">
