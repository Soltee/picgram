<template>
    <div class="relative flex flex-row items-center relative">
        <div 
            @click="menu = !menu;" 
            class="flex items-center border rounded-lg p-1">
            ...
            <!-- </a> -->
            <svg v-if="menu" class="h-6 w-6 text-blue-light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                <polyline points="18 15 12 9 6 15"></polyline>
            </svg>
            <svg v-else  class="h-6 w-6 text-blue-light" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
        ...
        <ul 
            v-if="menu"
            class="m-0 flex flex-col absolute right-0 top-0 mt-10 p-1 rounded shadow-xl z-20 bg-c-white">
            <a class="" :href="`/profile/${auth.id}/${auth.name}`">
                <li
                    class="flex py-1 px-2 cursor-pointer items-center group hover:bg-blue-light rounded-lg mb-2">
                
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8    bg-cover rounded-full text-blue-light group-hover:text-c-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span 
                        class="ml-2 text-sm text-blue-light group-hover:text-c-white">Profile
                    </span>
                </li>
            </a>
            ...
            <li 
                ...
                <svg 
                    class=" hover:opacity-75 h-8 w-8 text-blue-light group-hover:text-c-white"
                    xmlns="http://www.w3.org/2000/svg" 
                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-line join="round" stroke-width="0.9" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                </svg>
                <span 
        ...
        <div v-if="logoutModal">
            <div class="fixed inset-0  rounded-lg flex flex-col  justify-center rounded-lg z-40">
