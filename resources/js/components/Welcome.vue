<template>
    <div class="min-h-screen overflow-hidden flex-1 bg-c-white z-20 px-6  md:px-0 flex flex-col">
        <div v-if="loginModal" class="z-20 mt-6 flex flex-col">
        ...
        <div v-else class="z-20 flex flex-col mt-6">
