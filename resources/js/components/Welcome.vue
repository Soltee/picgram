<template>
    <div class="min-h-screen overflow-hidden flex-1 bg-gray-800 py-6 z-20 px-3 md:px-0">
        <div v-if="loginModal" class="z-20">
            <div class=" md:pl-12 text-lg  font-semibold">
                <div class="flex flex-row items-center">
                    <svg class="h-8 w-8 text-white pr-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
            ...
            <form :action="`/login`" :method="`post`" class="mt-4" id="loginForm">
                ...
                <div class="md:pl-12">
                    <div class="mb-4">
                        ...
                        <input class=" text-gray-800 rounded appearance-none   w-full md:w-64  py-2 px-3  leading-tight focus:outline-none  border-b-2 border-transparent hover:border-b-2 hover:border-gray-800" :class="(emailErr.length > 0) ? 'is-invalid': ''" id="email" type="email" v-model="email" name="email" value="" autocomplete="email" autofocus placeholder="*******@gmail.com">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" text-gray-800 rounded appearance-none   w-full md:w-64  py-2 px-3  leading-tight focus:outline-none  border-b-2 border-transparent hover:border-b-2 hover:border-gray-800" :class="(passErr.length > 0) ? 'is-invalid': ''" id="password" type="password" v-model="password" name="password" autocomplete="password" autofocus placeholder="**********">
                    ...
                    <div class="flex flex-col my-4">
                        ...
                        <div class="w-full md:w-64  flex flex-row items-center justify-center">
                            <a :href="`/redirect`" class="flex items-center bg-white rounded-full py-1 px-3">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="h-6 w-6 md:w-8 md:h-8 text-blue-600">
            ...
            <form :method="`post`" :action="`/register`" class="mt-4" id="registerForm">
                ...
                <div class="md:pl-12">
                    <div class="mb-4">
                        ...
                        <input class=" text-gray-800 rounded appearance-none   w-full md:w-64  py-2 px-3  leading-tight focus:outline-none  border-b-2 border-transparent hover:border-b-2 hover:border-gray-800" :class="(nameErr.length > 0) ? 'is-invalid' : '' " id="name" v-model="name" name="name" autocomplete="name" autofocus placeholder="Hari ....">
                    ...
                    <div class="mb-4">
                        ...
                        <input class=" text-gray-800 rounded appearance-none   w-full md:w-64  py-2 px-3  leading-tight focus:outline-none  border-b-2 border-transparent hover:border-b-2 hover:border-gray-800" :class="(passErr.length > 0) ? 'is-invalid': ''" id="password-confirm" type="password" v-model="confirm" autocomplete="new-password" autofocus placeholder="**********">
                    </div>
                    <div class="flex flex-col my-4">
